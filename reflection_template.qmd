...
editor: visual
execute: 
  eval: false #code is not being evaluated, dont need to read in packages or data
  echo: true
---
...
#okay so in this line of code; I could have tweaked it to use a function selected columns. Within the mutate function I could have 
teacher_evals_clean <- teacher_evals |>
  rename(sex = gender) |>
  filter(no_participants > 10) |>
  mutate(teacher_id = as.character(teacher_id),
